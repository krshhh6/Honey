...
import React, { useLayoutEffect, useEffect, useRef, useCallback, ReactNode, CSSProperties } from 'react';
  ...
  const getScrollData = useCallback(() => {
    if (useWindowScroll) {
      return {
        ...
        containerHeight: window.innerHeight || document.documentElement.clientHeight || 0,
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    try {
      ...
      cardsRef.current.forEach((card, i) => {
        ...
        const pinEnd = Math.max(pinStart + 1, endElementTop - containerHeight / 2);
