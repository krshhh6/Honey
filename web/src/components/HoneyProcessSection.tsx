...
export default function HoneyProcessSection() {
  ...
  const botanicalLeftRef = useRef<HTMLImageElement | null>(null);
  const botanicalRightRef = useRef<HTMLImageElement | null>(null);
  const iconRefs = useRef<(HTMLDivElement | null)[]>([]);
  const cardRefs = useRef<(HTMLElement | null)[]>([]);
  const [activeModalStep, setActiveModalStep] = useState<StepItem | null>(null);
